# Wonder - Marketing - Micro Frontend

This project is a Micro Frontend build with Single SPA (create-single-spa) and React. It is used to build the Landing and Pricing page of the application.
